...
import { ShoppingCart, UserPlus, Eye, EyeOff, Loader } from 'lucide-react'
    ...
    <div className="min-h-screen bg-main flex items-center justify-center p-4">
      <div className="w-full max-w-sm bg-surface rounded-xl border border-card-border p-8">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-xl font-bold text-text-main">Create account</h1>
          <p className="text-sm text-text-muted mt-1">Get started with your admin panel</p>
        </div>
